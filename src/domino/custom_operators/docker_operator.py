    ...
    def __init__(
        ...
        **docker_operator_kwargs
        ...
        if dev_pieces:
            ...
            mounts = [
                # TODO remove
                Mount(source='/Users/nathan/Developer/Tauffer-Consulting/domino/src/domino', target='/usr/local/lib/python3.10/site-packages/domino/', type='bind', read_only=True),
