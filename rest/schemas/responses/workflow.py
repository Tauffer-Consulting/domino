...
class BatchWorkflowFailureDetail(BaseModel):
    id: int
    message: str


class BatchWorkflowSuccessDetail(BaseModel):
    message: str


class BatchWorkflowResponse(BaseModel):
    result: str
    details: List[BatchWorkflowFailureDetail] | BatchWorkflowSuccessDetail
