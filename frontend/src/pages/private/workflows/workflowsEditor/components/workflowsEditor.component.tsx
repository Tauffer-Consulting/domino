...
import { useWorkflowsEditor } from "context/workflows/workflowsEditor.context";
...
import { PermanentDrawerRightWorkflows } from "./drawerMenuComponent";
import { ContainerResourceFormSchema } from "./sidebarForm.component/containerResourceForm.component";
import { createInputsSchemaValidation } from "./sidebarForm.component/pieceForm.component/validation";
import { storageFormSchema } from "./sidebarForm.component/storageForm.component";
import SidebarSettingsForm, {
  WorkflowSettingsFormSchema,
} from "./sidebarSettingsForm.component";
import WorkflowEditorPanelComponent from "./workflowEditorPanel.component";
/**
 * Create workflow tab
