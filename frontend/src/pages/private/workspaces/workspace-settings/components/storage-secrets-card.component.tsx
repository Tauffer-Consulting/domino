...
const StorageSecretsCard = () => {
    ...
    }, [getValues, repositoryId, patchRepositorySecret, refreshSecrets, resetField])
    ...
    const storageForms = useMemo(() => {
        ...
        return auxListItems
    }, [secrets, currrentEdittingSecretId, register, repositoryId, handleEditSecret, handleSaveSecret])
