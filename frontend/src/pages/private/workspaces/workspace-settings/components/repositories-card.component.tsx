...
import { IOperatorRepositoryMetadata } from 'services/requests/piece'
...
export const RepositoriesCard: FC = () => {
  ...
  const handleSelectRepository = useCallback((e: any) => {
  ...
  const handleDeleteOperatorRepository = useCallback((e: React.SyntheticEvent<HTMLButtonElement>) => {
    const repositoryId = e.currentTarget.value
        ...
        {!!repositories.length ? (
          <List>
            {repositories.map((repo, index) => (
              <ListItem key={index} selected={selectedIndex?.toString() === repo.id.toString()}>
                <ListItemAvatar>
                ...
                <IconButton value={repo.id} onClick={handleDeleteOperatorRepository}>
