...
import { IWorkflowSettings } from '../types/settings'
...
export const [WorkflowSettingsDataContext, useWorkflowSettings] = createCustomContext<IWorkflowSettingsContext>('WorkflowSettingsContext')

const WorkflowSettingsDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
