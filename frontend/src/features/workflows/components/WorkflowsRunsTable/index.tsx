...
export const WorkflowsRunsTable = () => {
          ...
          if (params.value === "success") {
            return (
              ...
              <Chip
                label="Success"
                color="success"
                style={{ backgroundColor: "#02b120", fontWeight: "bold" }}
              />
            );
          }
          ...
          if (params.value === "running") {
            return (
              <Chip
                label="Running"
                color="info"
                style={{ backgroundColor: "#00b0ff", fontWeight: "bold" }}
              />
            );
          }
        },
  ...
  const { rowsData, totalRows } = useMemo(() => {
    const rowsData = Array.isArray(workflowRuns.data)
      ? workflowRuns.data.map(
          (run: {
            workflow_run_id: any;
            start_date: any;
            end_date: any;
        ...
        >
          <DataGrid
            ...
            onPageSizeChange={(newPageSize) => {
              setRunsTablePageSize(newPageSize);
            }}
